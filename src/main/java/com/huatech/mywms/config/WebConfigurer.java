...
import com.huatech.mywms.web.filter.CachingHttpHeadersFilter;
import com.huatech.mywms.web.filter.StaticResourcesProductionFilter;
import com.huatech.mywms.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    private void initClusteredHttpSessionFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
        ...
        parameters.put("instance-name", "myWMS");
